  ...
  Widget build(BuildContext context) {
    return ListView(
      children: const [
        ...
        ProfileAvatar(),
        SizedBox(height: 18),
        ProfileSectionTitle('المعلومات الأساسية'),
        SizedBox(height: 10),
        ProfileLabel('الاسم الكامل'),
        ProfileInput(hint: 'الاسم الكامل', icon: Icons.person_outline_rounded),
        SizedBox(height: 12),
        ProfileLabel('الجنس'),
        GenderSelector(),
        SizedBox(height: 14),
        ProfileLabel('تاريخ الميلاد'),
        ProfileInput(
          hint: 'DD/MM/YYYY',
        ...
        SizedBox(height: 12),
        ProfileLabel('البريد الإلكتروني'),
        ProfileInput(
        ...
        SizedBox(height: 18),
        ProfileSectionTitle('معلومات العنوان'),
        SizedBox(height: 10),
        ProfileLabel('العنوان'),
        ProfileInput(hint: 'العنوان', icon: Icons.location_on_outlined, multiLine: true),
        SizedBox(height: 18),
        ProfileSectionTitle('جهة اتصال الطوارئ'),
        SizedBox(height: 10),
        ProfileLabel('اسم ولي الأمر'),
        ProfileInput(hint: 'اسم ولي الأمر', icon: Icons.person_outline_rounded),
        SizedBox(height: 12),
        ProfileLabel('صلة القرابة'),
        ProfileInput(hint: 'صلة القرابة', icon: Icons.person_outline_rounded),
        SizedBox(height: 12),
        ProfileLabel('رقم الموبايل'),
        ProfileInput(
          hint: 'رقم الموبايل',
...
class GenderSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Row(
      children: [
        GenderOption(label: 'ذكر', selected: true),
        SizedBox(width: 22),
        GenderOption(label: 'أنثى', selected: false),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: const Text('حفظ', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800)),
      ),
    );
  }
}
