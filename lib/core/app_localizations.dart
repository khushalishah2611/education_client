...
const Map<String, Map<String, dynamic>> _fallbackValues = {
  'en': {
    ...
    'documentLinkUnavailable': 'Document link is unavailable.',
  ...
  'ar': {
    ...
    'alreadyUploaded': 'تم الرفع مسبقًا',
    'openDocument': 'فتح المستند',
    'documentLinkUnavailable': 'رابط المستند غير متاح.',
    ...
    'Min\nAdmis%': 'أدنى\nنسبة قبول%',
    'Track': 'المسار',
    'Details / Apply': 'التفاصيل / التقديم',
    'Details': 'التفاصيل',
    'Apply & Pay\nApplication Fee': 'قدّم وادفع\nرسوم الطلب',
